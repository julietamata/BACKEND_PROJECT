...
router.post('/register', passport.authenticate('register', {failureRedirect: 'partials/errors'}), registerPassportController);
router.post('/login', passport.authenticate('login', {failureRedirect: 'session/login'}), loginPassportController)
router.get('/github', passport.authenticate('github', {scope: ['user:email']}),githubController);
router.get('/githubcallback',passport.authenticate('github',{failureRedirect: 'session/login'}),githubCallbackController )
router.get("/error", errorsController);
